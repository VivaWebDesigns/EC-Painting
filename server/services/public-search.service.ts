...
const FALLBACK_PAGE_DOCUMENTS: FallbackPageDocument[] = [
  ...
  },
  {
    ...
    metadata: "Service",
    searchableText: "interior painting walls ceilings trim doors popcorn ceiling removal wallpaper removal drywall repair Charlotte NC",
  ...
  },
  {
    ...
    metadata: "Service",
    searchableText: "exterior painting siding brick stucco trim shutters pressure washing wood rot repair Charlotte NC",
